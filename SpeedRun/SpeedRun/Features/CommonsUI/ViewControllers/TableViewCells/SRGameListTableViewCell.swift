...
class SRGameListTableViewCell: SRBaseTableViewCell {
    ...
    override func configure(cellVM: SRBaseTableViewCellViewModel) {
        ...
        guard let cellVM = cellVM as? SRGameListCellViewModel else { return }
...
class SRGameListCellViewModel: SRBaseTableViewCellViewModel {
    ...
    init(titleText: String?, imagePathURL: URL?, imageWith: CGFloat?, imageHeight: CGFloat?, cellActionIdentifier: Any? = nil) {
        super.init(cellType: .gameListCell)
